...
if DevLuffye(user_id) == true then
var = true
...
elseif tonumber(user_id) == tonumber(1054308380) then  
var = "مبرمج السورس"  
elseif DevLuffye(user_id) == true then
var = "المطور الاساسي"  
elseif tonumber(user_id) == tonumber(bot_id) then  
var = "البوت"
...
if status == "lock" then
key = {{{text = 'ᴍᴀᴛʀɪх ᴛᴇᴀᴍ', url="https://t.me/lllEll2"}}}   
...
keyboard.inline_keyboard = {
{
{text = 'LuFFy TEαM .',url="t.me/lllEll2"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local t = ' \n◊￤تم تفعيل شعر'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'Luffy:Matrix'..msg.chat_id_) 
end
if text == "تعطيل شعر" and Owner(msg)  then
local t = ' \n◊￤تم تعطيل شعر'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'Luffy:Matrix'..msg.chat_id_,true)  
end
if text == "شعر" and not database:get(bot_id..'Luffy:Matrix'..msg.chat_id_) then
...
if database:get(bot_id.."Luffy:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:del(bot_id.."Luffy:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_)
...
database:set(bot_id.."Luffy:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
return false 
end
...
database:set(bot_id.."Luffy:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true2")
return false 
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."Luffy:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '◊￤الان ارسل الرد الذي تريد اضافته \n◊￤قد يكون (ملف - فديو - نص - ملصق - بصمه - متحركه )\n◊￤يمكنك اضافه الى النص :\n- `#username` > اسم المستخدم\n- `#msgs` > عدد رسائل المستخدم\n- `#name` > اسم المستخدم\n- `#id` > ايدي المستخدم\n- `#stast` > موقع المستخدم \n- `#edit` > عدد السحكات ')
database:set(bot_id.."Luffy:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_,"true1")
...
if text and text:match("^(.*)$") then
if database:get(bot_id.."Luffy:Set:Manager:rd"..msg.sender_user_id_..":"..msg.chat_id_.."") == "true2" then
...
function Function_Luffy(extra, result, success)
if DevLuffye(result.sender_user_id_)  then
...
if DevLuffye(msg.sender_user_id_)  then
database:srem(bot_id.."DEV:Sudo:T",result.sender_user_id_)
database:srem(bot_id.."Luffy:Sudo:User", result.sender_user_id_)
database:srem(bot_id.."Luffy:Basic:Constructor"..msg.chat_id_,result.sender_user_id_)
database:srem(bot_id.."Luffy:Constructor"..msg.chat_id_, result.sender_user_id_)
...
if text == (database:get(bot_id.."Luffy:Name:Bot") or "ماتركس") then
Namebot = (database:get(bot_id.."Luffy:Name:Bot") or "ماتركس")
local namebot = {
'لابسك لتلح',
'لاتوصخ اسمي',
'هاقلبي؟ كول',
...
if text == 'تحديث ماتركس' and DevLuffy(msg) then
...
local Text = "\n◊￤يوزر البوت ⇠ "..textee.."\n◊￤اسم البوت ⇠ "..texte.."\n◊￤من سورس ⇠ [LuFFy TEαM](https://t.me/lllEll2)"
if bo.photos_[0] then
x = {} 
x.inline_keyboard = {
...
if text == 'اريد بوت' or text == 'اريد مطور' or text == 'خوش سورس' or text == 'مطور السورس' or text == 'اريد بوت تمبلر' or text == 'سورس ماتركس' or text == 'عجبني البوت' or text == 'منو منصبلك' or text == 'منو مطور السورس' or text == 'اريد انصب بوت' or text == 'سورس ماتركس' or text == '@lllEll1' then
...
send(msg.chat_id_, msg.id_,' ◊￤[تحديثات ﭑݪسورس](https://t.me/infoo_Luffy) \n ◊￤[قناه ﭑݪسورس](https://t.me/lllEll2)')
end
if text == 'المطور ↝' or text == 'مطور' or text == 'المطورين' then
local Text_Dev = database:get(bot_id..'Luffy:Text_Dev')
if Text_Dev then 
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
◊￤ميزة خاصة بسورس ماتركس 🐉 .
◊￤ارسل كلمة { بحث } + الكلمة المراد البحث عنها في اليوتيوب مثلا { بحث ماتركس } سيتم تحميلها على شكل اغنية وارسالها لك 🐉 .
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
◊￤Carbon ≻≻  * ]].. UserName..[[
]]
keyboard = {} 
...
if database:get(bot_id.."Luffy:Set:Manager:rd"..data.sender_user_id_..":"..data.chat_id_) then
database:del(bot_id.."Luffy:Set:Manager:rd"..data.sender_user_id_..":"..data.chat_id_)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'LuFFy TEαM .',url='http://t.me/lllEll2'}},
}
...
local Name_Bot = (database:get(bot_id.."Luffy:Name:Bot") or "ماتركس")
